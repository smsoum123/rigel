...
#include<ctime>
#include <d3d11.h>
// D3DX11 (D3DX11tex.h) is deprecated and may not be available. Provide minimal
// forward declarations and prototype used by this project so it can compile.
typedef struct D3DX11_IMAGE_LOAD_INFO { } D3DX11_IMAGE_LOAD_INFO;
struct ID3DX11ThreadPump;
#include <tchar.h>
#include <cstdio>
#include "vampimg.h"
// Do not link against D3DX11.lib as it may be unavailable. Provide a minimal
// stub implementation below to allow compilation. Note: image loading will
// be a no-op when the real D3DX11 library is not present.
...
// Minimal stub implementation to avoid link-time dependency on D3DX11.lib.
// This returns E_NOTIMPL and clears the output SRV. If the project has the
// legacy D3DX11 library available, replace this stub by linking against it
// or remove this definition.
inline HRESULT WINAPI D3DX11CreateShaderResourceViewFromMemory(
	ID3D11Device* pDevice,
	const void* pSrcData,
	SIZE_T SrcDataSize,
	const D3DX11_IMAGE_LOAD_INFO* pLoadInfo,
