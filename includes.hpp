...
namespace OW {
	...
	enum eHero : uint64_t
	{
		...
		HERO_FREJA = 0x02E000000000032A,
	    HERO_HAZARD = 0x02E0000000000362,
	    HERO_WUYANG = 0x02E00000000003C3,
	    HERO_VENDETTA = 0x02E0000000000472,
	    HERO_DOMINA = 0x02E00000000004C4,
	    HERO_Emre = 0x02E00000000004D8,
	    HERO_Anran = 0x02E00000000004DD,
	    HERO_Mizuki = 0x02E00000000004E3,
	    HERO_JetpackCat = 0x02E0000000000516,
		TOBTERT = 0x16dd,
		SYMTERT = 0x16ee,
		Bob = 0x16bb,
	};
